...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $imagePath = $brand['image_path']; // keep old image by default
  ...
  if (!empty($_FILES['image']['name'])) {
    ...
    if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
      ...
      if (!empty($brand['image_path']) && file_exists("../" . $brand['image_path'])) {
  ...
  if ($error === '') {
    ...
    $stmt->bind_param("sssii", $name, $description, $imagePath, $status, $id);
          ...
          <div class="card my-4">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-3 pb-3 d-flex align-items-center">
                ...
                <!-- Page Title -->
                <h6 class="text-white text-capitalize ps-3">Update Brand</h6>
              </div>
            </div>
              ...
              <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6">
                  ...
                  <form method="post" enctype="multipart/form-data" class="custom-form">
                    ...
                    <h5 class="mb-4 text-center fw-bold">Update Brand</h5>
                    ...
                    <div class="mb-3">
                      ...
                      <textarea
                        name="description"
                        class="form-control"
                        rows="3"><?= htmlspecialchars($brand['description']) ?></textarea>
                    </div>
                    ...
                    <?php if (!empty($brand['image_path'])): ?>
                      <div class="mb-3">
                        ...
                        <img src="../<?= htmlspecialchars($brand['image_path']) ?>" width="120" class="rounded border">
                      </div>
                    <?php endif; ?>
